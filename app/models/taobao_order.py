...
class TaobaoOrder(Base):
    ...
    buyer_company_name = Column(String(255), nullable=True, default='', comment='买家公司名')
    buyer_username = Column(String(128), nullable=True, default='', comment='买家会员名')
    seller_company_name = Column(String(255), nullable=True, default='', comment='卖家会员名')
    ...
    sender = Column(String(255), nullable=True, default='', comment='发货方')
    receiver_name = Column(String(128), nullable=True, default='', comment='收货人姓名')
    receiver_address = Column(String(255), nullable=True, default='', comment='收货地址')
    receiver_postcode = Column(String(20), nullable=True, default='', comment='邮编')
    receiver_phone = Column(String(255), nullable=True, default='', comment='联系电话')
    receiver_cellphone = Column(String(255), nullable=True, default='', comment='联系手机')
    product_category = Column(String(20), nullable=True, default='', comment='货品种类')
    comment = Column(String(255), nullable=True, default='', comment='买家留言')
    logistic_company_name = Column(String(255), nullable=True, default='', comment='物流公司')
...
class TaobaoProduct(Base):
    ...
    product_name = Column(String(255), nullable=True, default='', comment='货品标题')
